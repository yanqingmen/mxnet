...
public class Initializer {
    ...
    public static final String[] libNames = new String[] {"mxnet4j"};
    
    public static synchronized void InitMXNet() throws IOException {
    ...
    /**
     * load native library, this method will first try to load library from java.library.path,
     * then try to load library in jar package.
     * @param libName
     * @throws IOException 
     */
